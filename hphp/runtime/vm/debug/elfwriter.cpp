...
Dwarf_Unsigned dwarf_transform_to_disk_form_compat(
  ...
  std::conditional<
    std::is_invocable<decltype(dwarf_transform_to_disk_form_a), Dwarf_P_Debug, Dwarf_Unsigned*, Dwarf_Error*>::value,
    Dwarf_Unsigned,
    Dwarf_Signed
  >::type count;
...
Dwarf_Ptr dwarf_get_section_bytes_compat(
  ...
  std::conditional<
    std::is_invocable<decltype(dwarf_get_section_bytes_a), Dwarf_P_Debug, Dwarf_Signed, Dwarf_Unsigned*, Dwarf_Unsigned*, Dwarf_Ptr*, Dwarf_Error*>::value,
    Dwarf_Unsigned,
    Dwarf_Signed
  >::type bcSectionIndex;
